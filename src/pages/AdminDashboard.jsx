...
function AdminDashboard() {
  ...
  const recentLikes =
    dashboard?.recentLikes || [];

  const popularTracks =
    dashboard?.popularTracks || [];
      ...
      <div className="mx-auto flex min-h-screen max-w-[1600px] flex-col lg:flex-row">
        <aside className="border-b border-[var(--border)] bg-[var(--surface)]/65 px-4 py-5 lg:w-64 lg:shrink-0 lg:border-b-0 lg:border-r lg:px-5 lg:py-7">
          <div className="flex items-center justify-between lg:block">
            ...
            <Link
              to="/dashboard"
              className="text-xs font-medium text-[var(--text-secondary)] transition hover:text-violet-300 lg:mt-8 lg:inline-flex lg:items-center lg:gap-2"
            >
          ...
          <div className="mt-7 hidden rounded-2xl border border-emerald-500/20 bg-emerald-500/5 p-4 lg:block">
            ...
            <p className="mt-2 text-xs leading-5 text-[var(--text-secondary)]">
              The API and database responded successfully to this workspace.
            </p>
          </div>
            ...
            <div className="space-y-8 pt-8">
              <section className="relative overflow-hidden rounded-[28px] border border-violet-500/20 bg-gradient-to-br from-violet-600/20 via-[var(--card)] to-fuchsia-600/10 p-6 sm:p-8">
                ...
                <div className="relative flex flex-col gap-5 sm:flex-row sm:items-end sm:justify-between">
                  ...
                  <button
                    ...
                    className="inline-flex shrink-0 items-center justify-center gap-2 rounded-xl bg-white px-4 py-2.5 text-sm font-bold text-zinc-900 transition hover:scale-[1.02]"
                  >
                    <HiUserGroup />
                    Manage members
                  </button>
              ...
              <section className="space-y-4">
                <div className="grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
                  ...
                  <StatCard
                    icon={
                      <HiNoSymbol className="text-xl" />
                    }
                    label="Suspended accounts"
                    value={stats.suspendedUsers}
                    detail="Cannot sign in or use the API"
                    tone="emerald"
                  />
                </div>
                    ...
                    {popularTracks.length ? (
                      popularTracks
                        ...
                        .map((track, index) => (
                          ...
                          >
                            <span className="w-5 text-sm font-bold text-[var(--text-muted)]">
                              {index + 1}
                            </span>
            ...
            <div className="space-y-6 pt-8">
              ...
              <article className="overflow-hidden rounded-3xl border border-[var(--border)] bg-[var(--card)] shadow-xl shadow-black/5">
                <form
                  ...
                  className="grid gap-3 border-b border-[var(--border)] p-5 lg:grid-cols-[minmax(0,1fr)_150px_160px_auto_auto]"
                >
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full rounded-xl border border-[var(--border)] bg-[var(--surface)] py-2.5 pl-10 pr-3 text-sm outline-none transition placeholder:text-[var(--text-muted)] focus:border-violet-500 focus:ring-2 focus:ring-violet-500/10"
                    />
                  </div>
                  ...
                  <select
                    ...
                    className="rounded-xl border border-[var(--border)] bg-[var(--surface)] px-3 py-2.5 text-sm outline-none focus:border-violet-500"
                  >
                    <option value="">
                      All roles
                    </option>
                  ...
                  <button
                    ...
                    className="rounded-xl bg-violet-600 px-4 py-2.5 text-sm font-semibold text-white transition hover:bg-violet-500 disabled:cursor-wait disabled:opacity-60"
                  >
                    Apply
                  </button>
                  ...
                  <button
                    ...
                    disabled={loadingMembers}
                    className="rounded-xl border border-[var(--border)] px-4 py-2.5 text-sm font-semibold text-[var(--text-secondary)] transition hover:border-violet-500/40 hover:text-violet-300 disabled:opacity-60"
                  >
                    Reset
                  </button>
                </form>
                    ...
                    {popularTracks.length ? (
                      popularTracks.map(
                        (track, index) => (
                          ...
                          >
                            <span className="w-5 text-sm font-bold text-violet-300">
                              {index + 1}
                            </span>
                            ...
                            <div className="rounded-xl bg-fuchsia-500/10 px-3 py-2 text-right">
